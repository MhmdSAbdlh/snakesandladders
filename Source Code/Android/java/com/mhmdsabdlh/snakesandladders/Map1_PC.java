...
public class Map1_PC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map1_pc);
    ...
    private void endGame(String s) {
        win.start();
        Map1_PC.this.runOnUiThread(() -> new AlertDialog.Builder(Map1_PC.this).setTitle("Game Over")
                .setMessage(s)
